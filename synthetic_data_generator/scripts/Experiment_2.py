...
TARGET_OBJECTS = {
    ...
    "Rock": 1,     
    "Wood": 2,     
    "Wood_2": 2    # İkinci ahşap nesnesi aynı sınıfa bağlandı
}

FRAME_STEP = 3  

SCENARIOS = [
    {"name": "wood_part1", "target_obj": "Wood", "start_frame": 1, "end_frame": 118},
    {"name": "rock_part1", "target_obj": "Rock", "start_frame": 270, "end_frame": 393},
    {"name": "koli", "target_obj": "Koli", "start_frame": 620, "end_frame": 810},
    {"name": "wood_part2", "target_obj": "Wood_2", "start_frame": 1110, "end_frame": 1245}
]
