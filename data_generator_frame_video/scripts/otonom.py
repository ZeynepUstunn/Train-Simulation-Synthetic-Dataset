...
# --- KULLANICI AYARLARI ---
base_output_dir = r"D:\datasets_videos_all\multi_dataset\video_seti_varyasyon_2"
...
def is_object_visible_by_raycast(scene, camera, target_mesh):
    """Nesnenin köşelerine ışın fırlatarak gerçekten görünür olup olmadığını anlar."""
    ...
    test_points = [target_mesh.matrix_world.translation] + corners
...
def run_pipeline():
    ...
    print("\n================ TEK SEFERLİK SAHNE RENDERI BAŞLIYOR ================")
